        ...
        <div className="flex flex-col justify-between gap-8 md:gap-0   md:flex-row ">
          ...
          >
            ...
            <p className=" text-lg leading-relaxed mb-6">
              With over 2+ years of hands-on experience in frontend development,
              I specialize in building fast, user-friendly web apps using React,
              Next.js, and modern UI systems. I've worked with startups and
              growing businesses, turning ideas into responsive,
              production-ready interfaces.
            </p>
            <p className="  text-lg leading-relaxed mb-6">
              I'm passionate about clean code, user-centered design, and staying
